          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF231145), shape: BoxShape.circle),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      // كلمة مستخدم باللون الأحمر مثلما طلبت تماماً
...
class _GameSetupScreenState extends State<GameSetupScreen> {
  int roomsCount = 4; // القيمة الافتراضية 4 غرف مثل طلبك
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // زر فتح روم الذي ينقلك مباشرة للبحث عن الأجهزة في الشبكة المحلية
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF8B5CF6),
                minimumSize: const Size.fromHeight(55),
...
// شاشة البحث عن الأجهزة المفتوحة على نفس الهوتسبوت أو الشبكة اللوكال
...
class _LocalRoomSearchScreenState extends State<LocalRoomSearchScreen> {
  ...
  void initState() {
    ...
    // محاكاة البحث عن أجهزة متصلة بالهوتسبوت أو الشبكة المحلية
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (context) => MainGameRoomScreen(
                      ...
                      imposterIndices: const [1], // تعيين إمبوستر افتراضي
                    ),
                  ),
                );
              },
...
class _MainGameRoomScreenState extends State<MainGameRoomScreen> {
  ...
  void initState() {
    ...
    // تشغيل الساوند إفكت فور دخول الروم
